...
{
	partial class DialogEquipmentGroupFilter
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "DialogEquipGroupFilter";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "フィルタ設定";
			this.Load += new System.EventHandler(this.DialogEquipmentGroupFilter_Load);
