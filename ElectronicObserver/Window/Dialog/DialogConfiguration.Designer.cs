namespace ElectronicObserver.Window.Dialog
{
	partial class DialogConfiguration
	{
		...
		private void InitializeComponent()
		{
			...
			this.Log_SaveEquippedBonusLog = new System.Windows.Forms.CheckBox();
			...
			this.FormCompass_NextEnemyFleetShowtype = new System.Windows.Forms.ComboBox();
			...
			this.Notification_ConditionRepair = new System.Windows.Forms.Button();
		...
		"より大きくなる場合があります)。\r\n無効にした場合、動作が若干重くなる可能性があります。");
			...
			this.tabPage3.Controls.Add(this.Log_SaveEquippedBonusLog);
		...
		"せますが、多少処理が重くなる可能性があります。\r\nなお、「ログをファイルに保存する」無効時には本指定は無効になります。");
			...
			// 
			// Log_SaveEquippedBonusLog
			// 
			this.Log_SaveEquippedBonusLog.AutoSize = true;
			this.Log_SaveEquippedBonusLog.Location = new System.Drawing.Point(8, 165);
			this.Log_SaveEquippedBonusLog.Name = "Log_SaveEquippedBonusLog";
			this.Log_SaveEquippedBonusLog.Size = new System.Drawing.Size(159, 19);
			this.Log_SaveEquippedBonusLog.TabIndex = 8;
			this.Log_SaveEquippedBonusLog.Text = "装備ボーナスログを保存する";
			this.ToolTipInfo.SetToolTip(this.Log_SaveEquippedBonusLog, "装備ボーナス検出ログを保存するかを指定します");
			this.Log_SaveEquippedBonusLog.UseVisualStyleBackColor = true;
			// 
			// Log_SaveBattleLog
			// 
		...
		"す。ご了承ください。");
			...
			"従来の計算式",
			"増援防衛戦力・戦車 (2025年秋イベント E2)",
			"増援防衛戦力・内火艇 (2025年春イベント E5)"});
		...
		"の場合は音量ミキサ等で調整できますが、個別の音量設定は無視されます。");
			...
			this.Debug_SealingPanel.Size = new System.Drawing.Size(696, 191);
		...
		"に開く方は有効にすると便利です。");
			...
			this.Life_CheckUpdateInformation.Enabled = false;
			...
			this.tabPage8.Controls.Add(this.FormFleet_ShowSanmaEquip);
			this.tabPage8.Controls.Add(this.FormFleet_ShowSupportPower);
			...
			this.FormFleet_ShowAntiGroundPower.Location = new System.Drawing.Point(6, 259);
		...
		"。\r\n「両方表示」の場合は常にどちらも表示します。");
			...
			// tabPage18
			// 
			this.tabPage18.Controls.Add(this.FormCompass_NextEnemyFleetShowtype);
			...
			// 
			// FormCompass_NextEnemyFleetShowtype
			// 
			this.FormCompass_NextEnemyFleetShowtype.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.FormCompass_NextEnemyFleetShowtype.FormattingEnabled = true;
			this.FormCompass_NextEnemyFleetShowtype.Items.AddRange(new object[] {
			"画面で確認できる先頭の3隻",
			"過去に遭遇した全ての候補",
			"過去に遭遇した中から先頭の3隻が該当する候補"});
			this.FormCompass_NextEnemyFleetShowtype.Location = new System.Drawing.Point(143, 94);
			this.FormCompass_NextEnemyFleetShowtype.Name = "FormCompass_NextEnemyFleetShowtype";
			this.FormCompass_NextEnemyFleetShowtype.Size = new System.Drawing.Size(275, 23);
			this.FormCompass_NextEnemyFleetShowtype.TabIndex = 17;
			// 
			// label46
			// 
			...
			this.FormCompass_DoMergeByFormation.Location = new System.Drawing.Point(6, 127);
		...
		"かもしれません。\r\n* この変更は再起動後に適用されます。\r\n");
			...
			// tabPage11
			// 
			this.tabPage11.Controls.Add(this.Notification_ConditionRepair);
			...
			this.Notification_BaseAirCorps.TabIndex = 6;
			...
			this.Notification_AnchorageRepair.TabIndex = 5;
			...
			this.BGMPlayer_ControlGrid.Size = new System.Drawing.Size(684, 211);
			...
			// 
			// Notification_ConditionRepair
			// 
			this.Notification_ConditionRepair.Location = new System.Drawing.Point(8, 210);
			this.Notification_ConditionRepair.Name = "Notification_ConditionRepair";
			this.Notification_ConditionRepair.Size = new System.Drawing.Size(150, 23);
			this.Notification_ConditionRepair.TabIndex = 7;
			this.Notification_ConditionRepair.Text = "母港給糧艦通知の設定...";
			this.Notification_ConditionRepair.UseVisualStyleBackColor = true;
			this.Notification_ConditionRepair.Click += new System.EventHandler(this.Notification_ConditionRepair_Click);
			// 
			// UI_RenderingTest
			// 
		...
		private System.Windows.Forms.CheckBox Log_SaveEquippedBonusLog;
