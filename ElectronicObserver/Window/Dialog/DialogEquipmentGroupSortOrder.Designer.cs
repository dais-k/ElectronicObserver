...
{
	partial class DialogEquipmentGroupSortOrder
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "DialogEquipmentGroupSortOrder";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "自動ソート順";
			this.Load += new System.EventHandler(this.DialogEquipmentGroupSortOrder_Load);
