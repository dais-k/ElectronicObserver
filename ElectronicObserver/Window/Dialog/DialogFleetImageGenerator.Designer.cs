namespace ElectronicObserver.Window.Dialog
{
	partial class DialogFleetImageGenerator
	{
		...
		private void InitializeComponent()
		{
            ...
            this.AvoidTwitterDeterioration.Size = new System.Drawing.Size(148, 19);
            this.AvoidTwitterDeterioration.TabIndex = 5;
            this.AvoidTwitterDeterioration.Text = "X の画像圧縮を回避する";
            this.ToolTipInfo.SetToolTip(this.AvoidTwitterDeterioration, "X に PNG 形式の画像をアップロードすると、自動的に JPEG 形式に変換され画質が劣化します。\r\nそれを回避するための情報を埋め込むかを指定します。");
