namespace ElectronicObserver.Window
{
	partial class FormMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.StripMenu_Tool_KcWeb_OpenwithFleet.Text = "艦隊編成を反映(&N)";
			...
			this.StripMenu_Tool_SupportKai_OpenwithFleet.Text = "艦隊編成をコピーし開く(&K)";
			...
			this.StripMenu_Tool_CompassSim_OpenwithFleet.Size = new System.Drawing.Size(225, 22);
			this.StripMenu_Tool_CompassSim_OpenwithFleet.Text = "艦隊編成をコピーし開く(&P)";
			...
			this.StripMenu_Tool_CompassSim_Open.Size = new System.Drawing.Size(225, 22);
